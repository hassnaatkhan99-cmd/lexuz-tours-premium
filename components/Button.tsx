...
export function WhatsAppButton({ tourName }: { tourName?: string }) {
  ...
  return (
    <Link href={whatsappUrl(message)} target="_blank" rel="noopener noreferrer" className="focus-ring premium-shine magnetic-hover inline-flex min-h-12 items-center justify-center gap-2 rounded-dsMd bg-brand-whatsapp px-5 py-3 text-sm font-bold text-white shadow-ds1 transition hover:-translate-y-0.5 hover:brightness-95 hover:shadow-ds2">
