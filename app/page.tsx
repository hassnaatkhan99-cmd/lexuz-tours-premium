    ...
    <>
      ...
      <section className="forest-band py-20 text-white"><div className="container-page grid gap-8 lg:grid-cols-[1fr_0.82fr] lg:items-center">
        <figure className="overflow-hidden rounded-dsLg border border-lexuzNeutral-line bg-white shadow-ds3">
          <Image src={tripPhotos.groupMeadowBanner.src} alt={tripPhotos.groupMeadowBanner.alt} width={tripPhotos.groupMeadowBanner.width} height={tripPhotos.groupMeadowBanner.height} sizes="(min-width: 1024px) 46vw, 100vw" className="h-[360px] w-full object-cover" />
