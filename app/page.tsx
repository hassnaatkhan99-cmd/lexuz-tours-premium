...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="container-page -mt-12 grid gap-4 rounded-[24px] border border-white/70 bg-white/82 p-4 shadow-[0_28px_90px_rgba(20,32,27,.16)] backdrop-blur-xl md:grid-cols-4">
        {trustFacts.map(([a, b]) => <div key={a} className="luxury-card rounded-dsMd bg-lexuzNeutral-canvas/90 p-4 text-center"><p className="text-lg font-black text-brand-primary">{a}</p><p className="mt-1 text-sm text-lexuzNeutral-60">{b}</p></div>)}
      </section>
