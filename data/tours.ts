...
export const tours: Tour[] = [
  {
    ...
    gallery: [destination.swatAlt, destination.sharaan, destination.kumrat],
  ...
  },
  {
    ...
    gallery: [destination.naranAlt, destination.shogran, destination.hunza],
  ...
  },
  {
    ...
    gallery: [destination.kashmirAlt, destination.ganga, destination.gangaAlt],
  ...
  },
  {
    ...
    gallery: [destination.kumratAlt, destination.jahazBanda, destination.katora],
  ...
  },
  {
    ...
    gallery: [destination.hunzaAlt, destination.fairy, destination.skardu],
  ...
  },
  {
    ...
    gallery: [destination.fairyAlt, destination.hunza, destination.hunzaAlt],
  ...
  },
  {
    ...
    gallery: [destination.skarduAlt, destination.hunza, destination.fairy],
  ...
  },
  {
    ...
    gallery: [destination.shogranAlt, destination.naran, destination.naranAlt],
  ...
  },
  {
    ...
    gallery: [destination.sharaanAlt, destination.shogran, destination.shogranAlt],
  ...
  },
  {
    ...
    gallery: [destination.gangaAlt, destination.kashmir, destination.kashmirAlt],
