...
export const seoLandingPages: SeoLandingPage[] = [
  ...
  { slug: "honeymoon-tours-pakistan", title: "Honeymoon Tours Pakistan | Private Couple Trips", h1: "Honeymoon Tours Pakistan", description: "Premium honeymoon tours in Pakistan with private planning, scenic routes, flexible itineraries and couple-focused support.", keyword: "honeymoon tours Pakistan", relatedTours: ["hunza-valley", "skardu", "naran-kaghan"], audience: "married couples and honeymoon travelers", region: "Northern Pakistan", image: "/images/group-snow-lake-real.webp" },
  { slug: "corporate-tours-pakistan", title: "Corporate Tours Pakistan | Company Retreats", h1: "Corporate Tours Pakistan", description: "Corporate tours in Pakistan for team retreats, company trips, branded transport, hotel coordination and group logistics.", keyword: "corporate tours Pakistan", relatedTours: ["swat-kalam-mahodand", "naran-kaghan", "hunza-valley"], audience: "companies, teams, offices and corporate groups", region: "Pakistan", image: "/images/fleet-founder-buses.webp" },
  { slug: "university-tours-pakistan", title: "University Tours Pakistan | Student Trips", h1: "University Tours Pakistan", description: "University tours in Pakistan for student groups with managed transport, itineraries, group coordination and clear pricing.", keyword: "university tours Pakistan", relatedTours: ["shogran-siri-paye", "swat-kalam-mahodand", "hunza-valley"], audience: "universities, colleges and student societies", region: "Pakistan", image: "/images/group-snow-banner-real.jpeg" }
];
  ...
  return [
    {
      ...
      paragraphs: [
        `${page.keyword} by Lexuz Tours & Adventures are designed for travelers who want the excitement of Pakistan's mountain routes with the structure of a managed travel company. The experience is built around clear pricing, visible transport, practical itineraries, responsive WhatsApp support and a premium travel style that still feels friendly and personal. Whether you are planning from Islamabad, Rawalpindi, Lahore or arranging a private group, this guide explains what the destination offers, what is included, how the journey works and how Lexuz supports ${page.audience}.`,
